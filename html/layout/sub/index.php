...
<tr><td>'; 
$getshit11 = mysql_select_single('SELECT `id`, `name` FROM `players` ORDER BY `id` DESC LIMIT 1');  
...
echo '<center>Welcome to our newest player: <a href="characterprofile.php?name='.$getshit11['name'].'">'.$fetchshitt['name'].'</a></center></td></tr>'; 
