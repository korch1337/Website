...
if (isset($_GET['name']) === true && empty($_GET['name']) === false) {
	...
	if ($user_id !== false) {
		...
		<!-- PROFILE MARKUP HERE-->
			...
			<table id = "profile">
			<tr class="gradient"><td colspan="2">Character Information</td></tr>
...
<table id="profile">
    <tr>
        ...
        <td bgcolor="#F1E0C6" align="left">
            ...
            <div style="width: 100%; height: 8px; border: 1px solid #000;">
...
<tr class="darkborder"><td>
	<form type="submit" action="characterprofile.php" method="get">
		Name: <br><input type="text" size="25" name="name" class="search"><br><br>
