...
-->
<div style="background-image:url('streamtemple/backright.jpg');width:494px;height:972px;box-shadow:0 0 20px #000;font-family:Arial, sans-serif;border:2px solid black;margin:5px auto;text-align:center;overflow:hidden;position:relative;" id="templeAnimationWindow2"></div>
