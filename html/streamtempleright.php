...
-->
<div style="background-image:url('streamtemple/backrightedited.jpg');width:485px;height:975px;box-shadow:0 0 20px #000;font-family:Arial, sans-serif;border:2px solid black;margin:5px auto;text-align:center;overflow:hidden;position:relative;" id="templeAnimationWindow2"></div>
...
<script type="text/javascript">
    ...
    var imageCorrectionX = 24;
    var imageCorrectionY = -6;
   ...
   // -- END OF CONFIG --
    ...
    function handler(data)
    {
        ...
        {
            var k = obj[x];
            s += '<div style="z-index:1;position:absolute;top:'+(((k[1]-leftTopCornetY)*32)+imageCorrectionY)+'px;left:'+(((k[0]-leftTopCornetX)*32)+imageCorrectionX)+'px;width:64px;height:64px;background:transparent url(';
            if(k[3] == 0)
            {
        ...
        document.getElementById('templeAnimationWindow2').innerHTML = s;
    }
    function update()
    {
        var xhr;
