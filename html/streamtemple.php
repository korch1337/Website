...
<script type="text/javascript">
    ...
    function handler(data)
    {
        ...
        {
            var k = obj[x];
            s += '<div style="opacity:0.8;top:'+(((k[1]-leftTopCornetY)*32)+imageCorrectionY)+'px;left:'+(((k[0]-leftTopCornetX)*32)+imageCorrectionX)+'px;width:64px;height:64px;background:transparent url(';
            if(k[3] == 0)
            {
