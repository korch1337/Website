...
<script type="text/javascript">
   ...
   // -- END OF CONFIG --
    ...
    function handler(data)
    {
        ...
        {
            var k = obj[x];
            s += '<div style="opacity:0.8;z-index:1;position:absolute;top:'+(((k[1]-leftTopCornetY)*32)+imageCorrectionY)+'px;left:'+(((k[0]-leftTopCornetX)*32)+imageCorrectionX)+'px;width:64px;height:64px;background:transparent url(';
            if(k[3] == 0)
            {
